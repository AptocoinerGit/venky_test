...
output_path = "/lakehouse/default/Files/Bronze_Layer/Apaleo/properties/properties.json"
...
input_path = "Files/Bronze_Layer/Apaleo/properties/properties.json"
...
df_exploded = df_properties.withColumn("property", F.explode("properties"))
...
df_flat = df_exploded.select("property.*")
...
df_flat.write \
    ...
    .saveAsTable("DataLH.Silver_Properties")
