...
url = "https://api.apaleo.com/booking/v1/reservations?pageNumber=1&pageSize=5000"
...
output_path = "/lakehouse/default/Files/Bronze_Layer/Apaleo/reservations/reservations.json"
...
input_path = "Files/Bronze_Layer/Apaleo/reservations/reservations.json"
...
df_exploded = df_properties.withColumn("reservation", F.explode("reservations"))
...
df_flat = df_exploded.select("reservation.*")
...
df_flat.write \
    ...
    .saveAsTable("DataLH.Silver_reservations")
