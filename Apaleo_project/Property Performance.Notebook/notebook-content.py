...
# var todate =  gettoday() method
    # API URL with dynamic propertyId
    url = f"https://api.apaleo.com/reports/v1/reports/property-performance?propertyId=BER&from=2025-09-18&to=2025-09-01&expand=businessDays"
    ...
    output_path = f"/lakehouse/default/Files/Bronze_Layer/Apaleo/property-performance/{property_id}_property-performance.json"
...
for pid in property_ids:
    path = f"Files/Bronze_Layer/Apaleo/property-performance/{pid}_property-performance.json"
...
df_flat.write \
    ...
    .saveAsTable("DataLH.Silver_propertyperformance")
